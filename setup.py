...
setup(
    name='llmConnect',         # How you named your package folder (MyLib)
    ...
    download_url='https://github.com/Noor-Mohideen-S/llmConnect/archive/refs/tags/v_01.tar.gz',  # I explain this later on
